...
const Album1 = () => {
  ...
  const handleMoreImage = () => {
    if (
      next >=
      Math.max(column1.length, column2.length, column3.length, column4.length) -
        imagePerColumn
    ) {
    ...
    <>
      <div id="row">
        ...
        <div className="column">
          {column1.slice(0, next).map((details, index) => (
            <div key={index}>
              {" "}
              <LazyLoadImage
                onClick={() => {
        ...
        <div className="column">
          {column2.slice(0, next).map((details, index) => (
            <div key={index}>
              <LazyLoadImage
                onClick={() => {
                  {
        ...
        <div className="column">
          {column3.slice(0, next).map((details, index) => (
            <div key={index}>
              <LazyLoadImage
                onClick={() => {
                  {
        ...
        <div className="column">
          {column4.slice(0, next).map((details, index) => (
            <div key={index}>
              <LazyLoadImage
                onClick={() => {
                  {
