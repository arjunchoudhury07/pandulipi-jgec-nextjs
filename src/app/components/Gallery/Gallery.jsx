...
const Gallery = () => {
  return (
    <div id="canvas">
      ...
      >
        {/* <Link className='album_name text-center' to='./album1'>Album - 1</Link>
                <Link className='album_name text-center' to='./album2'>Album - 2</Link>
                <Link className='album_name text-center' to='./album3'>Album - 3</Link> */}
      </div>
