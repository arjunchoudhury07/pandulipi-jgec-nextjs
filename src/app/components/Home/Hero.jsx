  ...
  return (
    <div className="min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="m-5 py-14 rounded-3xl max-w-7xl bg-gray-300 bg-opacity-50 backdrop-blur-md transition-all duration-500 flex flex-col justify-center items-center">
        <h1 className="text-7xl antialiased xl:text-8xl font-semibold tracking-tighter">
          Pandulipi
        </h1>
        <h2 className="text-5xl antialiased xl:text-7xl text-center px-10 text-[#295C7A] font-semibold pt-5 tracking-tighter">
